...
| Phase | Tasks | Status |
|-------|-------|--------|
| Phase 1: iot-gateway | T001-T010 | Pending |
| Phase 2: iot-uplink | T011-T018 | Pending |
| Phase 3: iot-downlink | T019-T026 | Pending |
| Phase 4: iot-api | T027-T036 | Pending |
| Phase 5: iot-ws | T037-T044 | Pending |
| Phase 6: Integration | T045 | Pending |
...
### T036: API 契约测试
- [ ] **Description**: 编写 API 契约测试验证 OpenAPI 规范
...
```
Phase 1 (P1): T001 → T002 → T003, T004 → T005, T006, T007 → T008 → T009 → T010
Phase 2 (P1): T011 → T012, T013 → T014, T015 → T016 → T017 → T018
Phase 3 (P1): T019 → T020, T021 → T022, T023 → T024 → T025 → T026
Phase 4 (P2): T027 → T028, T029, T030, T031 → T032 → T033 → T034, T035, T036
Phase 5 (P2): T037 → T038 → T039 → T040 → T041 → T042 → T043 → T044
Phase 6:      T045 (depends on all phases)
```
