...
type Waylines struct {
	...
	TakeOffSecurityHeight    float64            `json:"take_off_security_height,omitempty" validate:"min=20,max=200"`
	...
	SafeHeight               float64            `json:"safe_height,omitempty" validate:"min=20,max=500"`
	Distance                 *float64           `json:"distance,omitempty" validate:"min=0"`
